...
You're welcome to add some tags to your posts. Just define the necessary section
at your post metadata:
...
After this, you may to use the Serious::Article#tags method to fetch the tags
of the post. More than all, Serious::Article.tags method is available and
designed to make your own tag cloud easily:

    Serious::Article.tags # => {"friendship"=>1, "magic"=>1}

The Serious::Article.all method is also modified to perform tagged search:

    Serious::Article.all :tag => "magic" # => [ ... ]

Your visitors may to visit the tagged archives by URL: /archives/:tag.
